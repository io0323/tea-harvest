"""
Working CI test file - Completely independent with no external dependencies
...
# 環境変数を設定
os.environ['PYTEST_CURRENT_TEST'] = 'test_ci_working'
...
def test_environment_variable_handling():
    ...
    assert 'test_ci_working' in current_test
