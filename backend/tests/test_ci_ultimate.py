"""
Ultimate CI test file - Completely independent with no external dependencies
This file avoids all the common CI issues by using only basic Python features
"""
import pytest
import io
import pandas as pd
...
# 環境変数を設定
os.environ['PYTEST_CURRENT_TEST'] = 'test_ci_ultimate'
...
def test_environment_variable_handling():
    ...
    assert 'test_ci_ultimate' in current_test
