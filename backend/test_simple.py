#!/usr/bin/env python3
"""
Simple test script to verify the API without TensorFlow dependencies
"""
import sys
import os
import json
...
# Set test environment to skip model loading
os.environ['PYTEST_CURRENT_TEST'] = 'true'

def test_simple():
    """Simple test without TensorFlow - only test API endpoints"""
    print("Testing simple API functionality...")
    ...
    try:
        ...
        with patch('app.models.tea_harvest_model.TeaHarvestModel', SimpleMockModel):
